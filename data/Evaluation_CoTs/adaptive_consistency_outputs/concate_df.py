    ...
    for model in model_names:
        ...
        for benchmark in benchmark_names:
            ...
            for file_name in os.listdir(directory):
                if file_name.endswith(f"seed{seed+1}_cleaned.csv"):
                    ...
                    print("No file ending with f'seed{seed+1}.csv' found in the directory.")
    df_all = pd.concat(li_of_data,ignore_index=True)
    df_all.to_csv(f'final_asc_seed{seed+1}.csv',index=False)